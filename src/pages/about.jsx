...
const about = () => {
  return (
    ...
    <div id='about' className='w-screen lg:h-[60rem] h-[45rem] bg-abu flex flex-col items-center lg:pt-44 pt-24 relative'>
        <h1 data-aos="fade-up"
     data-aos-duration="1000" className='lg:text-[2rem] font-beyonders text-potih'>ABOUT</h1>
        <div className='lg:flex lg:flex-row flex flex-col-reverse'>
            <div data-aos="fade-right" data-aos-duration="1000" className='w-[32rem] ml-60  lg:mt-[12.5rem] relative'>
            ...
            <div className='w-[60%]' >
              {/* gambar pc */}
                <img data-aos="fade-left" data-aos-duration="1000" src={gacor} alt="" className='hidden lg:block lg:h-[41rem] lg:max-w-[58rem] lg:relative -right-12'/>
                {/* gambar mobile */}
                <img data-aos="fade-left" data-aos-duration="1000" src={gacor} alt="" className='lg:hidden relative -right-52 '/>
            </div>
        </div>
    </div>
    </>
